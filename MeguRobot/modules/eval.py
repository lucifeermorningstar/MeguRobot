...
def do(func, bot, update):
    ...
    os.chdir(os.getcwd())
    with open(
        os.path.join(os.getcwd(), "MeguRobot/modules/helper_funcs/temp.txt"), "w"
    ) as temp:
        temp.write(body)
...
def clear(update: Update, context: CallbackContext):
    ...
    send("Locales limpiados.", bot, update)
...
__command_list__ = ["eval", "exec", "py", "clearlocals"]
