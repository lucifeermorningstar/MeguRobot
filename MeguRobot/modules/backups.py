    ...
    if checkchat.get("status"):
        if jam <= int(checkchat.get("value")):
            ...
            update.effective_message.reply_text(
                "Solo puedes hacer una copia de seguridad una vez al día!\nPodrás hacer una copia de seguridad de nuevo en aproximadamente `{}`".format(
                    timeformatt
                ),
...
•`/import`: Responde al archivo de respaldo para que Megu importe tanto como sea posible, haciendo que las transferencias sean muy fáciles! \
