...
if is_module_loaded(FILENAME):
    from MeguRobot import GLOBAL_LOGS, LOGGER, dispatcher
    from MeguRobot.modules.helper_funcs.chat_status import user_admin
    from MeguRobot.modules.sql import log_channel_sql as sql
    ...
    def logging(update: Update, context: CallbackContext):
        ...
        if log_channel:
            ...
            message.reply_text(
                "No se ha establecido ningún canal de registro para este grupo!"
            )
        ...
        if chat.type == chat.CHANNEL:
            ...
            try:
                ...
                if excp.message == "Forbidden: bot is not a member of the channel chat":
                    ...
                    LOGGER.exception("ERROR al configurar el canal LOGGER.")
