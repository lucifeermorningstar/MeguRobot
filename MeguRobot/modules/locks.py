        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    text = (
                        "Se bloquearon todos los {} mensajes para los miembros.".format(
                            ltype
                        )
                    )
                ...
                if conn:
                    ...
                    chat_name = chat.title
                    text = (
                        "Bloqueado {} para todos los no administradores en {}!".format(
                            ltype, chat_name
                        )
                    )
                else:
                    ...
                    chat_id = update.effective_chat.id
                    chat_name = update.effective_message.chat.title
                    text = "Bloqueado {} para todos los miembros!".format(ltype)
            ...
            send_message(update.effective_message, "Que estas tratando de bloquear...?")
    else:
        send_message(
            update.effective_message,
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    chat_id = update.effective_chat.id
                    chat_name = update.effective_message.chat.title
                    text = "{} mensajes desbloqueados para todos!".format(ltype)
            ...
            send_message(
                update.effective_message, "Que estas tratando de desbloquear?..."
            )
            ...
            if lockable == "bots":
                ...
                for new_mem in new_members:
                    if new_mem.is_bot:
                        ...
                        send_message(
                            update.effective_message,
                            "Solo los admins pueden agregar bots en este chat! Fuera de aquí.",
                        )
                        break
            else:
                try:
...
)  # , filters=Filters.chat_types.groups)
...
__command_list__ = ["lock", "unlock", "locks", "locktypes"]
